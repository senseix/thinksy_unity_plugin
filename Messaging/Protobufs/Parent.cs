...
namespace Senseix.Message.Parent {
	...
	public static partial class Parent {
		...
		static Parent() {
			byte[] descriptorData = global::System.Convert.FromBase64String(
				"ChV0dXRvcmlhbC9QYXJlbnQucHJvdG8SFnNlbnNlaXgubWVzc2FnZS5wYXJl" + 
	...
	public sealed partial class DeviceRegistrationResponse : pb::GeneratedMessage<DeviceRegistrationResponse, DeviceRegistrationResponse.Builder> {
		...
		private static readonly string[] _deviceRegistrationResponseFieldNames = new string[] { "auth_token", "player_id" };
		private static readonly uint[] _deviceRegistrationResponseFieldTags = new uint[] { 18, 10 };
		...
		public override void WriteTo(pb::ICodedOutputStream output) {
			...
			if (hasAuthToken) {
				output.WriteString(2, field_names[0], AuthToken);
			}
			UnknownFields.WriteTo(output);
		}
